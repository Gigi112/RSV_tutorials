...
CT1map = readOGR(dsn=path.expand('./WGS84'), layer= 'zipct_37800_0000_2010_s100_census_1_shp_wgs84')
...
###  Step 2. Create a neighbor matrix from the sorted shapefile 
```{r,message=FALSE}
...
###  Step 3. Create a W matrix for Leroux model 
```{r,message=FALSE}
