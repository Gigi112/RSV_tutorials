...
## Section 2: use maximum likelihood estimation (MLE) to estimate the unknown parameters

In this example, we will use maximum likelihood estimation (MLE) to estimate the (1) per capita transmission probability: baseline.txn.rate, (2) seasonal amplitude: Amp, (3) seasonal peak timing: phi, (4) duration of maternal immunity: DurationMatImmunityDays. 
\
\
