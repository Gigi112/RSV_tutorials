...
```{r,echo=T,eval=FALSE}
fitLL <- optim(par=c(2.2,-1.6,1.2,3.16),
...
exp(fitLL$par)
# output: 8.99  0.20  3.3 (same as+/-pi) 
# 23
...
Before we start, please learn the [Rstan basic](https://github.com/Gigi112/RSV_tutorials/tree/main/MSIS_model_explain/Introduction of Rstan.pptx) from the seperated tutorials in the same file path. 